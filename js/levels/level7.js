class Level7 extends Level {
    ...
    constructor() {
        ...
        this.arrows = [
            new Arrow(ClaculateUnit(25), ClaculateUnit(7), ClaculateUnit(3), ClaculateUnit(3), "left"),
            new Arrow(ClaculateUnit(13), ClaculateUnit(17), ClaculateUnit(3), ClaculateUnit(3), "up"),
        ];

        this.switches.push(
             new Switch(ClaculateUnit(18), ClaculateUnit(15), ClaculateUnit(3), ClaculateUnit(3), true),
        );
