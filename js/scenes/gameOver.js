class GameOver extends Scene {
    constructor() {
        ...
        this.text = [
            new TextOnly(0, ClaculateUnit(2), canvas.width, ClaculateUnit(3), "Game Over", ClaculateUnit(3), true),
        ...
        this.buttons = [
            new Button(middle, ClaculateUnit(8), widthOfBtn, ClaculateUnit(2), true, 2, "Restart", currentlvlIndex),
            new Button(middle, ClaculateUnit(12), widthOfBtn, ClaculateUnit(2), true, 1, "Main Menu", 0),
        ];
    }
